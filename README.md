...
7.	Взаимодействие между модулями происходит через API.
8.	Обращение к внешней системе происходит по протоколу HTTP.
9.	Внешние системы реализуют различные способы взаимодействия - синхронное, основанное на обратных вызовах, пуллинге.
10.	Одним из самых главных моментов при обращении к внешней системе является ведение полной истории таких обращений, обязательно включающее результаты обращения, длительность и уникальный id операции, который генерирует внешняя система при обращении.
11.	 Длительность процесса финализации +0.9 квантиль.
12.	 Количество запросов к внешней системе по поводу оповещения о “брошенной” корзине. Количество успешных/неуспешных сабмитов. “Неуспешность” должна быть сгруппирована по кодам ответа. Длительность вызова + 0.75, 0.9 квантили.
13.	Среднее время, которое проходит от бронирования до оплаты заказа. + 0.9 квантили
